...
shiftHolderMotorX=15; //difference between bar length and foundation, 25 for motor, 15 for opposite
shiftHolderX=0;
...
module barHolder(pX=0, pY=0, pZ=0, rX=0, rY=0, rZ=0, showMetall = false)
{
    ...
    //color(clr)
    {
        ...
        endStopHolder(pX=-4, pY=(vHBHolder[2]/2)+10, pZ=shiftHolderMotorX, rX=90, rY=0, rZ=-90, sizeY=35);
        if(showMetall){
